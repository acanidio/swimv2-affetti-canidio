...
public interface UserDataManagerRemote {
	...
	public boolean modifyUser(int IDUser, String password, String name, String surname, String city, Date birthday, String phonenumber);
	...
	public List<User> searchUsers(String username, String city, Integer abilityID);
