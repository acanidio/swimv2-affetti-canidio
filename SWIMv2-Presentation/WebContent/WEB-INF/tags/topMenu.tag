...
<c:if test="${type=='GUEST'}">
			...
			<div>
				<form name="search" method="get" action="search.servlet" onsubmit="return mandatory_Search();">
					...
					<div class="link"><a href="loadabilities.servlet?path=advsearch.view">Advanced Search</a></div>
				</form>
			</div>
			<div class="link"><a href="loadabilities.servlet?path=signup.view">Sign up</a></div>
			<div>
...
<c:if test="${type=='USER'}">
			<div class="link"><a href="home.view">Home</a></div>
			<div>
				<div class="link"><a href="pfrships.servlet">New Friendships</a></div>
				<div class="link"><a href="pmessages.servlet">New Messages</a></div>
			</div>
			<div>
				<form name="search" method="get" action="search.servlet" onsubmit="return mandatory_Search();">
					<div><input type="text" value="Username" style="color:#C0C0C0" name="username" onclick="if(value=='Username'){value=''; style.color='#000000';}" 
			...
			<div>
				<div class="link"><a href="loaduser.servlet?id=${sessionScope.person.ID}">${sessionScope.person.name} ${sessionScope.person.surname}</a></div>
				<div class="link"><a href="myhrs.servlet">Help Requests</a></div>
				<div class="link"><a href="conversations.servlet">Conversations</a></div>
			</div>
